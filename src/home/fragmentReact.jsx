...
const ELLIPSE_PATHS = [
  ...
  "M180.82 289.482C147.075 231.2 124.1 172.195 114.51 123.227c-11.544-59-3.382-104.11 19.864-117.566 24.224-14.024 70.055 2.244 118.14 44.94 36.356 32.28 73.688 80.837 105.723 136.173 32.844 56.733 57.46 114.21 67.036 162.582 12.117 61.213 2.31 107.984-21.453 121.74-23.057 13.348-65.25-.784-110.24-39.5-38.013-32.71-78.682-83.253-112.76-142.115z",
];
...
const ReactLogo = () => {
  return (
    <svg className='logo' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" version="1.1">
      <g transform="matrix(.05696 0 0 .05696 .647744 2.43826)" fill="none" fillRule="evenodd">
        {ELLIPSE_PATHS.map((path, idx) => <Ellipse key={idx} path={path} index={idx} />)}
      </g>
      <Circle />
    </svg>
  );
...
const Ellipse = (props) => {
  ...
  return (
    <>
      <path d={path} strokeWidth='16' stroke='#80deea' fill='transparent'/>
      <circle r={24} fill="#80deea">
        <animateMotion path={path} dur={(index + 1) * 2} repeatCount='indefinite'/>
      </circle> 
    </>
  );
};
...
const Circle = (props) => {
  ...
  return (
    <>
      <circle cx="16" cy="16" r={2} fill="#80deea"/>
    </>
  )
}